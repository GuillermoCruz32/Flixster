...
I tried rounding the corners on my images, but something wasn't getting imported properly from the Glide file and this caused my app to crash. I was not able to ever find the source of the bug, so I was not able to finish that stretch story.
